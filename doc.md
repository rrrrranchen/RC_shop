...
一直想做一款商城管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套管理系统。学习过程中遇到问题可以咨询微信：lengqin1024 或者发Email: kefu308@gmail.com

## 在线体验


- 代码下载：https://github.com/geeeeeeeek/java_shop
...
- 商品管理：管理系统可以录入、修改和查询商品的基本信息，如商品名称、价格、备注等。
...
```
mysql> use java_shop;
mysql> source D:/xxx/xxx/java_shop.sql;
```
